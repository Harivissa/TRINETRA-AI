...
interface Chokepoint { id?: string; name?: string; }
interface Props {
  nodes: Node[];
  edges: Edge[];
...
const chokepointCoordinates: Record<string, [number, number]> = {
  CHOKEPOINT_HORMUZ: [26.5, 56.25],
  CHOKEPOINT_MALACCA: [2.8, 101.4],
};
...
export default function WorldMap({ nodes, edges, chokepoints = [], onSelect, onSelectChokepoint }: Props) {
