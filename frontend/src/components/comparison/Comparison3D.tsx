...
function flag(id?: string) { const map: Record<string, string> = { IND: "🇮🇳", CHN: "🇨🇳", USA: "🇺🇸", RUS: "🇷🇺", JPN: "🇯🇵", GBR: "🇬🇧", FRA: "🇫🇷", DEU: "🇩🇪", KOR: "🇰🇷", TUR: "🇹🇷", SAU: "🇸🇦", IRN: "🇮🇷", ISR: "🇮🇱", PAK: "🇵🇰", AUS: "🇦🇺", CAN: "🇨🇦", BRA: "🇧🇷", IDN: "🇮🇩", ITA: "🇮🇹", ARE: "🇦🇪", BGD: "🇧🇩" }; return map[id || ""] || "🌐"; }
